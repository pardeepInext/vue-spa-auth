...
var router = new vue_router__WEBPACK_IMPORTED_MODULE_2__.default({
  ...
  routes: [{
    ...
    component: function component() {
      return __webpack_require__.e(/*! import() */ "resources_js_views_User_vue").then(__webpack_require__.bind(__webpack_require__, /*! ../views/User */ "./resources/js/views/User.vue"));
    }
  }]
});
...
var User = {
  ...
  mutations: {
    SET_LOGIN_ERROR: function SET_LOGIN_ERROR(state, payload) {
      return state.loginError = payload;
    },
    SET_REGISTER_ERROR: function SET_REGISTER_ERROR(state, payload) {
    ...
    SET_REGISTER_LOADING: function SET_REGISTER_LOADING(state, payload) {
      return state.isRegisterLoading = payload;
    },
    SET_USER: function SET_USER(state, payload) {
      return state.user = payload;
    },
    SET_LOGOUT_RES: function SET_LOGOUT_RES(state, payload) {
      return state.logoutResp = payload;
    },
    SET_LOGIN_RES: function SET_LOGIN_RES(state, payload) {
  ...
  actions: {
          ...
          while (1) {
            switch (_context.prev = _context.next) {
              case 0:
                ...
                data._token = csrf;
                _context.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post("".concat(url, "/api/user/login"), data).then(function (res) {
          ...
          while (1) {
            switch (_context2.prev = _context2.next) {
              case 0:
                ...
                data._token = csrf;
                _context2.next = 5;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().post("".concat(url, "/api/user/register"), data).then(function (res) {
    ...
    logout: function logout(_ref3, id) {
          ...
          while (1) {
            switch (_context3.prev = _context3.next) {
              case 0:
                commit = _ref3.commit;
                _context3.next = 3;
                return axios__WEBPACK_IMPORTED_MODULE_1___default().delete("".concat(url, "/api/logout/").concat(id)).then(function (res) {
                  return commit('SET_LOGOUT_RES', res.data.success);
                })["catch"](function (err) {
                  return err;
                });
...
var render = function() {
  ...
  return _c(
    ...
    {
      staticClass:
        "navbar navbar-expand-lg navbar-dark bg-dark text-white text-center"
    },
    [_vm._v("\n  © " + _vm._s(_vm.setYear) + "\n")]
  )
}
...
/******/ 			if ({"resources_js_views_Home_vue":1,"resources_js_views_Login_vue":1,"resources_js_views_Register_vue":1,"resources_js_views_User_vue":1}[chunkId]) return "js/" + chunkId + ".js";
